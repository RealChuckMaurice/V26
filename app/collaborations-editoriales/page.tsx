...
export default function CollaborationsEditoriales() {
      ...
      <section className="bg-accent/30 py-20 md:py-28">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center fade-in">
            <h1 className="text-4xl md:text-5xl font-serif mb-6">Collaborations éditoriales</h1>
            <p className="text-xl text-muted-foreground mb-8">
              Découvrez les institutions et maisons d'édition avec lesquelles je collabore régulièrement pour des
              projets éditoriaux.
            </p>
            <div className="flex justify-center">
              <div className="relative w-full max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-full border border-border bg-background focus:outline-none focus:ring-2 focus:ring-secondary"
                />
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {collaborations.map((collab, index) => (
              <Link
                href={`/collaborations-editoriales/${collab.id}`}
                key={collab.id}
